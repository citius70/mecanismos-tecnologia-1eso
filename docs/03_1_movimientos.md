...
* **Lineal** ➡️: La trayectoria del movimiento tiene forma de línea recta.
...
* **Lineal Alternativo** ↔️: La trayectoria del movimiento tiene forma de línea recta pero es un movimiento de ida y vuelta.
